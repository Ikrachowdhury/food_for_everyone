...
export default function Achievement() {
    ...
    const percentageFill = (rating - filledStars) * 100;
                                ...
                                <div className="cardLink">
                                    <div className="card shadow-sm bg-light" >
                                        <div className="card-body">
                                            ...
                                            <h4 className='rating-number fw-bold'>{rating.toFixed(1)}<small>/5</small></h4>
                                            <div className="mb-3">
                                            ...
                                            <div className='text-muted mb-3'><h5>234 ratings</h5></div>
                                            <div className='d-flex justify-content-center mb-1'>
                                                ...
                                                <h6 className='text-muted mx-3'>985</h6>
                                            </div>
                                            <div className='d-flex justify-content-center mb-1'>
                                                ...
                                                <h6 className='text-muted mx-3'>856</h6>
                                            </div>
                                            <div className='d-flex justify-content-center mb-1'>
                                                <h6 className='text-muted mx-3'>3 <FaStar className='mx-2' style={{ fontSize: 20 }} /></h6>
                                                <div className="progress " style={{ width: "50%", height: "22px" }}>
                                                    <div className="progress-bar bg-warning" role='progressbar' style={{ width: "45%" }} aria-valuenow="45" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                                <h6 className='text-muted mx-3'>745</h6>
                                            </div>
                                            <div className='d-flex justify-content-center mb-1'>
                                                ...
                                                <h6 className='text-muted mx-3'>564</h6>
                                            </div>
                                            <div className='d-flex justify-content-center mb-1'>
                                                ...
                                                <h6 className='text-muted mx-3'>485</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div className="card shadow-sm bg-light">
                                        <div className="card-body">
                                            ...
                                            <div className='mt-5'>
                                                <p className='text-muted' style={{ fontSize: "25px" }}>Total Points: 12 times</p>
                                                <p className='text-muted' style={{ fontSize: "25px" }}>Total Donated: {totalDelivered} times</p>
                                                <p className='text-muted' style={{ fontSize: "25px" }}>Total Money Donation: 25,000/-</p>
                                                <p className='text-muted' style={{ fontSize: "25px" }}>Total Donated Food: {totalServes} Persons</p>
                                                <p className='text-muted mb-4' style={{ fontSize: "25px" }}>Total Donated People: {totalDelivered} Donee</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
