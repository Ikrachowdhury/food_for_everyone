...
const TableData = [
    ...
    { id: 4, postName: 'Post 1', postDate: '12/4/24', quantity: '10', status: 'Canceled', donee: 'Ghizz', location: 'Biswanath', deliveryData: '13/2/4', rating: '1' },
    { id: 5, postName: 'Post 4', postDate: '15/4/24', quantity: '10', status: 'Delivered', donee: 'Jklmn', location: 'Garage', deliveryData: '13/2/4', rating: '4' },
    { id: 6, postName: 'Post 5', postDate: '16/4/24', quantity: '10', status: 'Delivered', donee: 'Opqr', location: 'Town Hall', deliveryData: '13/2/4', rating: '2' },
    { id: 7, postName: 'Post 6', postDate: '17/4/24', quantity: '10', status: 'Canceled', donee: 'Stuvwx', location: 'Rashid Colony', deliveryData: '13/2/4', rating: '3' },
    { id: 8, postName: 'Post 2', postDate: '13/4/24', quantity: '10', status: 'Delivered', donee: 'Abc', location: 'Sonapur', deliveryData: '13/2/4', rating: '3' },
    { id: 9, postName: 'Post 3', postDate: '14/4/24', quantity: '10', status: 'Expired', donee: 'Defy', location: 'Maijdee', deliveryData: '13/2/4', rating: '5' },
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th className="min-w-100px text-center"> Received Date </th>
                                ...
                                <tbody>
                                    {TableData.filter((doneelist) =>
                                        ...
                                        <tr key={order.id} >
                                            ...
                                            <td className="text-center" style={{ verticalAlign: 'middle' }}><button className='btn btn-outline-secondary' data-bs-toggle="modal" data-bs-target="#staticBackdrop" >Rate</button></td>
                                            <td className="text-center" style={{ verticalAlign: 'middle' }}><button className='btn btn-outline-secondary'>See Details</button></td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
