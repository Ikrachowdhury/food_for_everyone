                                                                            ...
                                                                            <div className="col-1 d-flex align-items-center justify-content-center">
                                                                                <div className="dropdown">
                                                                                    ...
                                                                                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                                        <li><button className="dropdown-item" onClick={() => handleCancelPost(donation.donationPost.donation_id)}>Cancel</button></li>
                                                                                        <li><button className="dropdown-item" data-bs-toggle="modal" data-bs-target="#detailsModal" onClick={() => handleDetailsModal(donation)}>Details</button></li>
